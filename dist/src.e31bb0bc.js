...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/TodoMenu.jsx":[function(require,module,exports) {
"use strict";
...
var TodoMenu = function TodoMenu(props) {
  var data = props.data,
      index = props.index,
      setIndex = props.setIndex;

  var handleClick = function handleClick(e) {
    var index = parseInt(e.target.dataset.index, 10); // dataset ie에서 미지원
...
var _default = TodoMenu;
exports.default = _default;
},{"react":"../node_modules/react/index.js"}],"components/TodoGroup.jsx":[function(require,module,exports) {
"use strict";
...
var TodoGroup = function TodoGroup(props) {
  var data = props.data,
      index = props.index;
  var dataset = data[index]; // 자체적인 state를 가짐. 갱신되어야기 때문에
  //const {list} = dataset; // 이렇게 넣으면 list 수정이 불가능하다. 그래서 밑에꺼로 수정

  var _useState = (0, _react.useState)(dataset.list),
  ...
  var TodoList = list.map(function (item, index) {
    var description = item.description,
        checked = item.checked; // onChange 필요하지만 추후 추가
  ...
  }), _react.default.createElement("button", null, "\uCD94\uAC00")), TodoList); // 어떤 그룹의 데이터를 노출시킬것인가에 대한 결정
  // 보통 api에는 각 그룹의 id가 있는데 여긴 없으니까 index로 처리
};

var _default = TodoGroup;
exports.default = _default;
...
var _TodoMenu = _interopRequireDefault(require("./TodoMenu"));

var _TodoGroup = _interopRequireDefault(require("./TodoGroup"));
...
var App = function App() {
  ...
  var dataGroups = DATA.result.groups;

  var _useState = (0, _react.useState)(0),
      _useState2 = _slicedToArray(_useState, 2),
      index = _useState2[0],
      setIndex = _useState2[1]; // TodoMenu에서만 index를 변경할 수 있으니까 setIndex 가짐


  return _react.default.createElement("div", {
    className: "app"
  }, _react.default.createElement("div", {
    className: "todo-group-list"
  }, _react.default.createElement(_TodoMenu.default, {
    data: dataGroups,
    index: index,
    setIndex: setIndex
  })), _react.default.createElement("div", {
    className: "todo-wrapper"
  }, _react.default.createElement(_TodoGroup.default, {
    data: dataGroups,
    index: index
  })));
};
...
var _default = App;
exports.default = _default;
},{"react":"../node_modules/react/index.js","./TodoMenu":"components/TodoMenu.jsx","./TodoGroup":"components/TodoGroup.jsx"}],"index.js":[function(require,module,exports) {
"use strict";
...
var Index = _react.default.createElement("div", {
  className: _index.default.app
}, _react.default.createElement(_App.default, null));

_reactDom.default.render(Index, document.querySelector('#app'));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./index.css":"index.css","./components/App":"components/App.jsx"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
